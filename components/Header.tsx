 ...
 <div className='container mx-auto px-4'>
  <div className='flex h-16 items-center justify-between gap-4'>
    ...
    <div className='flex items-center space-x-2 md:space-x-4'>
      ...
      <nav>
        <SignedIn>
        <Link prefetch={false} href='/my-courses' className='flex space-x-2 items-center text-sm font-medium text-muted-foreground hover:text-forground transition-colors md:border md:border-border md:rounded-md md:px-4 md:py-2'>
